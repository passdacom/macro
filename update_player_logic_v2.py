...
for i, line in enumerate(lines):
    if 'for action_idx, action in enumerate(grouped_actions):' in line:
        start_loop = i
        break
...
if start_loop != -1:
    ...
    print("Updated event_player.py with logic support (Corrected)")
